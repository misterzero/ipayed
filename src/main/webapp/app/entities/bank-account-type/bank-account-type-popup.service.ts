...
export class BankAccountTypePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.bankAccountTypeService.find(id)
                    .subscribe((bankAccountTypeResponse: HttpResponse<BankAccountType>) => {
                        const bankAccountType: BankAccountType = bankAccountTypeResponse.body;
